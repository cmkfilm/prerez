#!/usr/bin/env python3
"""
classify_project.py — Single-command wrapper for the Celluloid W-W-Wars
upscale classification pipeline.

Runs:
  1. Feature extraction  (clip_roundtrip_classify_v6_3.py)
  2. ML classification   (make_safe_predictions.py)
  3. Symlink bin generation

Usage:
  python3 classify_project.py /path/to/clips
  python3 classify_project.py /path/to/clips --project my_project
  python3 classify_project.py /path/to/clips --grain-floor 720
  python3 classify_project.py /path/to/clips --skip-extraction  (reuse existing TSV)
